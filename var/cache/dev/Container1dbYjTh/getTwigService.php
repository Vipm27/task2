...
class getTwigService extends App_KernelDevDebugContainer
{
    ...
    {
        $a = new \Twig\Loader\FilesystemLoader([], 'D:\\products-api');
        $a->addPath('D:\\products-api\\vendor\\symfony\\security-bundle/Resources/views', 'Security');
        $a->addPath('D:\\products-api\\vendor\\symfony\\security-bundle/Resources/views', '!Security');
        $a->addPath('D:\\products-api\\vendor\\doctrine\\doctrine-bundle/Resources/views', 'Doctrine');
        $a->addPath('D:\\products-api\\vendor\\doctrine\\doctrine-bundle/Resources/views', '!Doctrine');
        $a->addPath('D:\\products-api\\vendor\\doctrine\\doctrine-migrations-bundle/Resources/views', 'DoctrineMigrations');
        $a->addPath('D:\\products-api\\vendor\\doctrine\\doctrine-migrations-bundle/Resources/views', '!DoctrineMigrations');
        $a->addPath('D:\\products-api\\vendor\\api-platform\\core\\src\\Symfony\\Bundle/Resources/views', 'ApiPlatform');
        $a->addPath('D:\\products-api\\vendor\\api-platform\\core\\src\\Symfony\\Bundle/Resources/views', '!ApiPlatform');
        $a->addPath('D:\\products-api/templates');
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(($container->privates['debug.file_link_formatter'] ??= new \Symfony\Component\HttpKernel\Debug\FileLinkFormatter($container->getEnv('default::SYMFONY_IDE'))), 'D:\\products-api', 'UTF-8'));
